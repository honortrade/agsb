...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "ygkkk"         # 用户名
UUID = "36563916-335b-4ca2-9a70-61a8c4e762da"                     # UUID，留空则自动生成
PORT = 49999                   # Vmess端口，留空或0则自动生成
DOMAIN = "ygkkk.sevesetk05082.icu"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiMDgxNDQzZjZmNmNjNjM4YzI4YTU4NzAyMGI1ODc1NjIiLCJ0IjoiMzc0ZGI2YjMtNTVmMy00NTU3LTlmYWYtM2JiNWYyODUwNGVmIiwicyI6Ik9XWmxOV0ZoTURFdFlXTTFPQzAwWW1Fd0xXSmxNR0V0TldWaE1qSTJNakV4TjJVMiJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
